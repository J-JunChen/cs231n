...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        #(2)
        word_embediing_out, word_embedding_cache = word_embedding_forward(captions_in, W_embed)
        #(3)
        if self.cell_type == 'rnn':
          rnn_or_lstm_out, rnn_cache = rnn_forward(word_embediing_out, affine_out, Wx, Wh, b)
        elif self.cell_type == 'lstm':
          rnn_or_lstm_out, lstm_cache = lstm_forward(word_embediing_out, affine_out, Wx, Wh, b)
        #(4)
